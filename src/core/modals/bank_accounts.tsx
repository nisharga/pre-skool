        ...
        <div className="modal-body">
          <form >
            ...
            <div className="modal-btn">
              ...
              <Link  href="#" data-bs-dismiss="modal" type="submit" className="btn btn-primary">Save</Link>
            </div>
          </form>
        </div>
      </div>
          ...
          <form>
            <div className="success-message text-center">
              ...
              <div className="col-lg-12 text-center modal-btn">
                <Link href="#" className="btn btn-light" data-bs-dismiss="modal">Cancel</Link>
                <Link href="#" type="submit"  data-bs-dismiss="modal" className="btn btn-danger">Yes, Delete it</Link>
              </div>
            </div>
          </form>
        </div>
