              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom mb-4">
                    ...
                    <li>
                      <Link href={routes.teacherSalary} className="nav-link">
                        <i className="ti ti-report-money me-2" />
                        Salary
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.teacherLibrary} className="nav-link active">
...
export default TeacherLibraryComponent;
