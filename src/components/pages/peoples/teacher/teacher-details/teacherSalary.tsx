...
const TeacherSalaryComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: () => (
        <>
          <Link href="#" className="btn btn-light add-fee">
            View Payslip
          </Link>
        </>
      ),
              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom mb-4">
                    <li>
                      <Link href={routes.teacherDetails} className="nav-link ">
                        <i className="ti ti-school me-2" />
                        Teacher Details
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.teachersRoutine} className="nav-link ">
                        <i className="ti ti-table-options me-2" />
                        Routine
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.teacherLeaves} className="nav-link">
                    ...
                    <li>
                      <Link href={routes.teacherLibrary} className="nav-link">
...
export default TeacherSalaryComponent;
