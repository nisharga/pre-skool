            ...
            <div className="dropdown-menu drop-width" ref={dropdownMenuRef}>
              <form >
                ...
                <div className="p-3 d-flex align-items-center justify-content-end">
                  ...
                  <Link href={routes.teacherGrid} onClick={handleApplyClick} className="btn btn-primary">
                    Apply
                  </Link>
                </div>
              </form>
        ...
        <div className="col-xxl-3 col-xl-4 col-md-6 d-flex">
          <div className="card flex-fill">
            <div className="card-header d-flex align-items-center justify-content-between">
              <Link href={routes.teacherDetails} className="link-primary">
                T849127
              </Link>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Teresa</Link>
                    </h6>
                    <p>III A</p>
                  </div>
                </div>
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              ...
              <Link href={routes.teacherDetails} className="btn btn-light btn-sm">
                View Details
              </Link>
            </div>
          </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Daniel</Link>
                    </h6>
                    <p>II (A)</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Hellana</Link>
                    </h6>
                    <p>VI (A)</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Erickson</Link>
                    </h6>
                    <p>VI (B) , V (A)</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Morgan</Link>
                    </h6>
                    <p>VIII</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Aaron</Link>
                    </h6>
                    <p>I (A)</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Jacquelin</Link>
                    </h6>
                    <p>IV</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Raul</Link>
                    </h6>
                    <p>IV</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Elizabeth</Link>
                    </h6>
                    <p>VII</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Edward</Link>
                    </h6>
                    <p>IX (C) , X (C)</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Maria</Link>
                    </h6>
                    <p>IX (C) , X (C)</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link href={routes.teacherDetails}>Jacky</Link>
                    </h6>
                    <p>VI (A)</p>
                  </div>
                </div>
...
export default TeacherGridComponent