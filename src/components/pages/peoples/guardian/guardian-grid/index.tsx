                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Avila</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Claudia</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                        <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Jessie</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Edwin</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Michael</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Mary</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Robert</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Arthur</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Colleen</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Thomas</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Johnson</Link>
                        </h6>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-2">
                       <h6 className="text-dark text-truncate mb-0">
                          <Link href="#" onClick={() => setShow(true)}>Marquita</Link>
                        </h6>
        ...
        <div className="modal-body mb-0">
          ...
          <div className="border rounded p-4 pb-1 mb-3">
            ...
            <div className="d-flex align-items-center justify-content-between flex-wrap">
              <div className="d-flex align-items-center mb-3">
                <Link href={routes.studentDetail} className="avatar">
                  <ImageWithBasePath
                    src="assets/img/students/student-01.jpg"
                    className="img-fluid rounded-circle"
                    alt="img"
                ...
                <div className="ms-2">
                  <p className="mb-0">
                    <Link href={routes.studentDetail}>Janet</Link>
                  </p>
                  <span>III, A</span>
                </div>
              </div>
              ...
              <div className="d-flex align-items-center">
                <Link href="#" className="btn btn-light mb-3 me-3">
                  Add Fees
                </Link>
                <Link
                  href={routes.studentDetail}
          ...
          <div className="border rounded p-4 pb-1 mb-3">
            ...
            <div className="d-flex align-items-center justify-content-between flex-wrap">
              <div className="d-flex align-items-center mb-3">
                ...
                <div className="ms-2">
                  <p className="mb-0">
                    <Link href={routes.studentDetail}>Joann</Link>
                  </p>
                  <span>IV, B</span>
                </div>
              </div>
...
export default GuardianGridComponent;
