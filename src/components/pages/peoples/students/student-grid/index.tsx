            ...
            <div className="dropdown-menu drop-width" ref={dropdownMenuRef}>
              <form>
                ...
                <div className="p-3 d-flex align-items-center justify-content-end">
                  ...
                  <Link href={routes.studentGrid} className="btn btn-primary" onClick={handleApplyClick}>
                    Apply
                  </Link>
                </div>
              </form>
        ...
        <div className="col-xxl-3 col-xl-4 col-md-6 d-flex">
          <div className="card flex-fill">
            <div className="card-header d-flex align-items-center justify-content-between">
              <Link href={routes.studentDetail} className="link-primary">
                AD9892434
              </Link>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h5 className="mb-0">
                      <Link href={routes.studentDetail}>Janet Daniel</Link>
                    </h5>
                    <p>III, A</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Joann Michael</Link>
                    </h6>
                    <p>IV, B</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Kathleen Dison</Link>
                    </h6>
                    <p>III, A</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Lisa Gourley </Link>
                    </h6>
                    <p>II, B</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Ralph Claudia</Link>
                    </h6>
                    <p>II, B</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Julie Scott</Link>
                    </h6>
                    <p>V, A</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Susan Boswell</Link>
                    </h6>
                    <p>VIII, B</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Richard Mayes</Link>
                    </h6>
                    <p>V, A</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Veronica Randle</Link>
                    </h6>
                    <p>IX, A</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2">
                    <h6 className="mb-0">
                      <Link href={routes.studentDetail}>Thomas Hunt</Link>
                    </h6>
                    <p>X, A</p>
                  </div>
                </div>
