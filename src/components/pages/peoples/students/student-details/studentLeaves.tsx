              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom mb-4">
                    ...
                    <li>
                      <Link href={routes.studentResult} className="nav-link">
                        <i className="ti ti-bookmark-edit me-2" />
                        Exam &amp; Results
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.studentLibrary} className="nav-link">
...
export default StudentLeavesComponent;
