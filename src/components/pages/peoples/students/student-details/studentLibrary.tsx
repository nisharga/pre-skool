              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom mb-4">
                    <li>
                      <Link href={routes.studentDetail} className="nav-link">
                        <i className="ti ti-school me-2" />
                        Student Details
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.studentTimeTable} className="nav-link">
                        <i className="ti ti-table-options me-2" />
                        Time Table
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.studentLeaves} className="nav-link ">
                        <i className="ti ti-calendar-due me-2" />
                        Leave &amp; Attendance
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.studentFees} className="nav-link ">
                    ...
                    <li>
                      <Link href={routes.studentLibrary} className="nav-link active">
...
export default StudentLibraryComponent;
