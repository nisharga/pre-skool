                  ...
                  <div className="add-more-timetable">
                    ...
                    <div className="tab-content pt-0 dashboard-tab">
                            ...
                            <div className="col-lg-3">
                              <div className="d-flex align-items-end">
                                ...
                                <div className="mb-3 ms-2">
                                  <Link href="#" className="delete-time-table"  onClick={() => removeContent(index)}>
                      ...
                      >
                          ...
                          <div className="row timetable-count">
                            ...
                            <div className="col-lg-3">
                              <div className="d-flex align-items-end">
                                ...
                                <div className="mb-3 ms-2">
                                  <Link href="#" className="delete-time-table" onClick={() => removetuesdayContent(index)}>
                                    <i className="ti ti-trash" />
                                  </Link>
                                </div>
                                  )}
                        ...
                        <div>
                          <Link
                            href="#"   onClick={addTuesdayContent}
                            className="btn btn-primary add-new-timetable"
                          >
                            <i className="ti ti-square-rounded-plus-filled me-2" />
                            Add New
                          ...
                          <div className="row timetable-count">
                            ...
                            <div className="col-lg-3">
                              <div className="d-flex align-items-end">
                                ...
                                <div className="mb-3 ms-2">
                                  <Link href="#" className="delete-time-table" onClick={() => removewednessdayContent(index)}>
                                    <i className="ti ti-trash" />
                                  </Link>
                                </div>
                                )}
                          ...
                          <div className="row timetable-count">
                            ...
                            <div className="col-lg-3">
                              <div className="d-flex align-items-end">
                                ...
                                <div className="mb-3 ms-2">
                                  <Link href="#" className="delete-time-table" onClick={() => removethursdayContents(index)}>
                                    <i className="ti ti-trash" />
                                  </Link>
                                </div>
                                )}
                          ...
                          <div className="row timetable-count">
                            ...
                            <div className="col-lg-3">
                              <div className="d-flex align-items-end">
                                ...
                                <div className="mb-3 ms-2">
                                  <Link href="#" className="delete-time-table" onClick={() => removefridayContents(index)}>
                                    <i className="ti ti-trash" />
                                  </Link>
                                </div>
                                )}
...
export default ClassTimetableComponent;
