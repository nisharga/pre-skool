...
const StaffsAttendanceComponents = () => {
                ...
                <div className="my-auto mb-2">
                  ...
                  <nav>
                    <ol className="breadcrumb mb-0">
                      ...
                      <li className="breadcrumb-item">
                        <Link href={routes.studentList}>HRM</Link>
                      </li>
                      <li
              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom mb-4">
                    <li>
                      <Link href={routes.staffDetails} className="nav-link">
                        <i className="ti ti-info-square-rounded me-2" />
                        Basic Details
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.staffPayroll} className="nav-link ">
                        <i className="ti ti-file-dollar me-2" />
                        Payroll
                      </Link>
                    </li>
                    <li>
                      <Link href={routes.staffLeave} className="nav-link">
...
export default StaffsAttendanceComponents;
