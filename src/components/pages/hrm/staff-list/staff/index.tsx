  ...
  const columns = [
    {
      ...
      render: ( text: string) => (
        <>
          <Link href={routes.staffDetails} className="link-primary">
            {text}
          </Link>
        </>
      ),
    ...
    },
    {
      ...
      render: (text: string, record: any) => (
        <div className="d-flex align-items-center">
          <Link href={routes.staffDetails} className="avatar avatar-md">
            <ImageWithBasePath
              src={record.img}
          ...
          <div className="ms-2">
            <p className="text-dark mb-0">
              <Link href={routes.staffDetails}>{text}</Link>
            </p>
          </div>
        </div>
      ),
