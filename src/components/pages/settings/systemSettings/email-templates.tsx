          ...
          <div className="row">
            <div className="col-xxl-2 col-xl-3">
              <div className="pt-3 d-flex flex-column list-group mb-4">
                <Link href={routes.emailSettings} className="d-block rounded p-2">
                  Email Settings
                </Link>
                <Link
                ...
                <Link href={routes.smsSettings} className="d-block rounded p-2">
                  SMS Settings
                </Link>
                <Link href={routes.optSettings} className="d-block rounded p-2">
                  OTP
                </Link>
                <Link href={routes.gdprCookies} className="d-block rounded p-2">
                  GDPR Cookies
                </Link>
              </div>
            </div>
