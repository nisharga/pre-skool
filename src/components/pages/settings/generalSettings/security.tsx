          ...
          <div className="row">
            <div className="col-xxl-2 col-xl-3">
              <div className="pt-3 d-flex flex-column list-group mb-4">
                ...
                <Link href={routes.securitysettings} className="d-block rounded p-2 active">
                  Security Settings
                </Link>
                <Link
                ...
                <Link href={routes.connectedApps} className="d-block rounded p-2">
                  Connected Apps
                </Link>
              </div>
            </div>
                ...
                <div className="d-block">
                  ...
                  <div className="d-flex justify-content-between align-items-center rounded flex-wrap bg-white border rounded p-3 pb-0 mb-3">
                    ...
                    <div className="d-flex align-items-center flex-wrap">
                      ...
                      <Link href="#" className="btn btn-light mb-3">
