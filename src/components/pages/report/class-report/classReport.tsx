...
const ClassReportComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: () => (
        <>
        <Link href="#" className="btn btn-light view details" data-bs-toggle="modal"
...
export default ClassReportComponent;
