          ...
          <div className="filter-wrapper">
            ...
            <div className="list-tab">
              <ul>
                ...
                <li>
                  <Link href={routes.studentAttendanceType}>
                ...
                <li>
                  <Link href={routes.studentDayWise} className="active">
                    Student Day Wise
                  </Link>
                </li>
                <li>
...
export default StudentDayWiseComponent;
