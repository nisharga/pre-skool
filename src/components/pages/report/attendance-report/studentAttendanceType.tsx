...
const StudentAttendanceTypeComponent = () => {
        ...
        <div className="content">
          ...
          <div className="filter-wrapper">
            ...
            <div className="list-tab">
              <ul>
                <li>
                  <Link href={routes.attendanceReport}>Attendance Report</Link>
                </li>
                <li>
                  <Link href={routes.studentAttendanceType} className="active">
                    Students Attendance Type
                  </Link>
                </li>
                <li>
                  <Link href={routes.dailyAttendance}>Daily Attendance</Link>
                </li>
                <li>
                  <Link href={routes.studentDayWise}>Student Day Wise</Link>
                </li>
                <li>
                  <Link href={routes.teacherDayWise}>Teacher Day Wise</Link>
                </li>
                <li>
                  <Link href={routes.teacherReport}>Teacher Report</Link>
                </li>
                <li>
                  <Link href={routes.staffDayWise}>Staff Day Wise</Link>
                </li>
                <li>
                  <Link href={routes.staffReport}>Staff Report</Link>
                </li>
              </ul>
            </div>
            {/* /List Tab */}
...
export default StudentAttendanceTypeComponent;
