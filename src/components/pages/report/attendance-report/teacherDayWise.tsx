          ...
          <div className="filter-wrapper">
            ...
            <div className="list-tab">
              <ul>
                ...
                <li>
                  <Link href={routes.studentDayWise}>
                    Student Day Wise
                  </Link>
                </li>
                <li>
                  <Link href={routes.teacherDayWise} className="active">Teacher Day Wise</Link>
                </li>
                <li>
...
export default TeacherDayWiseComponent;
