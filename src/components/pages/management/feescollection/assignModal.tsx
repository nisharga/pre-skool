...
const AssignModal = ({addModal,setAddModal,editModal,setEditModal}:any) => {
  ...
  <div className="modal-header">
                ...
                <div className="dropdown-menu drop-width" ref={dropdownMenuRef}>
                  <form >
                    ...
                    <div className="p-3 d-flex align-items-center justify-content-end">
                      ...
                      <Link href="#" className="btn btn-primary" onClick={handleApplyClick}>
                        Apply
                      </Link>
                    </div>
                  </form>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">
                          <p className="text-dark mb-0">
                            <Link href={routes.studentDetail}>Ralph</Link>
                          </p>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">
                          <p className="text-dark mb-0">
                            <Link href={routes.studentDetail}>Julie</Link>
                          </p>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">
                          <p className="text-dark mb-0">
                            <Link href={routes.studentDetail}>Ryan</Link>
                          </p>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">
                          <p className="text-dark mb-0">
                            <Link href={routes.studentDetail}>Susan</Link>
                          </p>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">
                          <p className="text-dark mb-0">
                            <Link href={routes.studentDetail}>Richard</Link>
                          </p>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">
                          <p className="text-dark mb-0">
                            <Link href={routes.studentDetail}>Veronica</Link>
                          </p>
                        </div>
                      </div>
                    </td>
        ...
        <div className="modal-footer">
          <Link href="#" onClick={handleClose} className="btn btn-light me-2" data-bs-dismiss="modal">
            Cancel
          </Link>
          <Link href={routes.feesAssign} onClick={handleClose} className="btn btn-primary">
            Add Fees
          </Link>
        </div>
  </Modal>
