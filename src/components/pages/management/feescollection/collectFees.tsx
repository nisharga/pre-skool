  ...
  const columns = [
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="ms-2">
            <p className="text-dark mb-0">
              <Link href={routes.studentDetail}>{text}</Link>
            </p>
    ...
    },
    {
      ...
      render: (text: string) => (
        <>
          {text === "Paid" ? (
            <Link href={routes.studentFees} className="btn btn-light">
              View Details
            </Link>
          ) : (
            <Link
            ...
            <div className="my-auto mb-2">
              ...
              <nav>
                <ol className="breadcrumb mb-0">
                  ...
                  <li className="breadcrumb-item">
                    <Link href="#">Fees Collection</Link>
                  </li>
...
export default CollectFeesComponent;
