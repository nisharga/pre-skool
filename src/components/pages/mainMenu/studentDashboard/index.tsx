...
const StudentDasboardComponent = () => {
                    ...
                    <div className="card bg-dark position-relative">
                      <div className="card-body">
                        ...
                        <div className="d-flex align-items-center justify-content-between profile-footer flex-wrap row-gap-3 pt-4">
                          ...
                          <Link href={routes.editStudent} className="btn btn-primary">
                            Edit Profile
                          </Link>
                        </div>
            ...
            <div className="col-xxl-4 d-flex">
              <div className="card flex-fill">
                <div className="card-header d-flex align-items-center justify-content-between">
                  ...
                  <Link href={routes.feesAssign} className="link-primary fw-medium">
                    View All
                  </Link>
                </div>
                        ...
                        <div className="d-flex align-items-center overflow-hidden mb-3">
                          ...
                          <div className="overflow-hidden">
                            ...
                            <h6 className="text-truncate mb-1">
                              <Link href={routes.classHomeWork}>
                    ...
                    <div className="card bg-light-100 mb-0">
                      <div className="card-body">
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <div>
                            <h6 className="mb-1 text-truncate">
                              <Link href={routes.teacherDetails}>Daniel Josua</Link>
                            </h6>
                            <p>Spanish</p>
                          </div>
                        </div>
            ...
            <div className="col-xxl-4 col-xl-6 d-flex">
              <div className="card flex-fill">
                <div className="card-header  d-flex align-items-center justify-content-between">
                  ...
                  <Link href={routes.noticeBoard} className="fw-medium">
                    View All
                  </Link>
                </div>
                <div className="card-body">
...
export default StudentDasboardComponent;
