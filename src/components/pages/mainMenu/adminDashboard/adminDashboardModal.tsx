    ...
    <div className="modal fade" id="add_class_routine">
        ...
        <div className="modal-content">
            ...
            <form >
                ...
                <Link data-bs-dismiss="modal" href={routes.adminDashboard} className="btn btn-primary">
                    Add Class Routine
                </Link>
                </div>
            </form>
    ...
    <div className="modal fade" id="add_event">
        ...
        <div className="modal-content">
            ...
            <div className="modal-footer">
                ...
                <Link href={routes.adminDashboard} data-bs-dismiss="modal" className="btn btn-primary">
                Save Changes
                </Link>
            </div>
            </form>
