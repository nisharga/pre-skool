                    ...
                    <div className="card-body pb-0">
                      <div className="bg-light-300 rounde border p-3 mb-3">
                        ...
                        <div className="d-flex align-items-center gap-1 flex-wrap">
                          <Link href="#" className="badge badge-lg bg-success">
                            M
                          </Link>
                          <Link href="#" className="badge badge-lg bg-success">
                            T
                          ...
                          <Link href="#" className="badge badge-lg bg-danger">
                            F
                          </Link>
                          <Link
                            href="#"
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-flex align-items-center justify-content-between p-3 mb-0 border rounded">
                        <div className="d-flex align-items-center overflow-hidden me-2">
                          ...
                          <div className="overflow-hidden">
                            <h6 className="mb-1 text-truncate">
                              <Link href="#">Veronica Randle</Link>
                            </h6>
                            <p>V, B</p>
                          </div>
                        </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div className="ms-2">
                                <p className="text-dark mb-0">
                                  <Link href={routes.studentDetail}>
                                    Kathleen
                                  </Link>
                                </p>
                              </div>
