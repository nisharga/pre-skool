            ...
            <div className="col-xxl-4 col-xl-6 d-flex">
              <div className="card flex-fill">
                <div className="card-header  d-flex align-items-center justify-content-between">
                  ...
                  <Link href={routes.events} className="fw-medium">
                    View All
                  </Link>
                </div>
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="overflow-hidden">
                            <h6 className="mb-1">
                              <Link href={routes.events}>Farewell</Link>
                            </h6>
                            <p>
                              <i className="ti ti-calendar me-1" />
                              11 Mar 2024
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="overflow-hidden">
                            <h6 className="mb-1">
                              <Link href={routes.events}>Annual Day</Link>
                            </h6>
                            <p>
                              <i className="ti ti-calendar me-1" />
                              11 Mar 2024
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="overflow-hidden">
                            <h6 className="mb-1">
                              <Link href={routes.events}>Holi Celebration</Link>
                            </h6>
                            <p>
                              <i className="ti ti-calendar me-1" />
                              15 July 2024
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="overflow-hidden">
                            <h6 className="mb-1">
                              <Link href={routes.events}>Exam Result</Link>
                            </h6>
                            <p>
                              <i className="ti ti-calendar me-1" />
                              16 July 2024
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div className="ms-2">
                                <p className="text-dark mb-0">
                                  <Link href={routes.studentDetail}>Gifford</Link>
                                </p>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div className="ms-2">
                                <p className="text-dark mb-0">
                                  <Link href={routes.studentDetail}>Lisa</Link>
                                </p>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div className="ms-2">
                                <p className="text-dark mb-0">
                                  <Link href={routes.studentDetail}>Riana</Link>
                                </p>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              <div className="ms-2">
                                <p className="text-dark mb-0">
                                  <Link href={routes.studentDetail}>Angelo</Link>
                                </p>
                              </div>
                            </div>
                          </td>
