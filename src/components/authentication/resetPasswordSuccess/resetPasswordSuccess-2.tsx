...
const ResetPasswordSuccess2Component = () => {
            ...
            <div className="col-md-8 mx-auto p-4">
              ...
              <div className="card">
                <div className="card-body text-center">
                  ...
                  <Link href={routes.login2} className="btn btn-primary w-100">Back to Login</Link>
                </div>
              </div>
...
export default ResetPasswordSuccess2Component